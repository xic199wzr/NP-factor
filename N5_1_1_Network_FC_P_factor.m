...
% BL_matrix_all = {rand(100,268*268);rand(100,268*268);rand(100,268*268);rand(100,268*268)};
% BL_subject_all = repmat(1:100,4,1)';
% BL_subject = repmat({1:100},4,1)';
...
for i=1:4
 ...
 TableS9_2.BL_FC_tale = BL_FC_tale;
 TableS9_2.FU2_Task_tale = FU2_Task_tale;
 TableS9_2.FU2_Rest_tale = FU2_Rest_tale;
 
 TableS9_2.BL_FC_mat = Across_FC_mat(:,[1,2:9]);
 TableS9_2.FU2_Task_FC_mat = Across_FC_mat(:,[1,10:17]);
 TableS9_2.FU2_Rest_FC_mat = Across_FC_mat(:,[1,18:25]);
  
 TableS9_2.Across_FC_ind = Across_FC(:,1:9);
 
save A5_1_1_2_Network_FC_V2.mat TableS9_2 Across_FC
