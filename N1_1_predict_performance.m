...
load('/share/inspurStorage/home1/xic_fdu/project/IAMGEN_Develop_diagnostic_0814/Trans_diagnostic_p_facotr/MyColormaps_mycmap_tras_brain.mat')

[BL_Exter_beha,BL_Inter_beha,BL_Pheno_residual_match_sub] = xic_CPM_beha;

for  j = 1:8

    models = dir(fullfile('/share/inspurStorage/home1/xic_fdu/project/IAMGEN_Develop_diagnostic_0814/CPM_Models/',['*',model_name{j}]));
...
R_predict_pos(R_predict_pos<0.075)=0; 
R_predict_neg(R_predict_neg<0.075)=0; 
R_predict_both(R_predict_both<0.075)=0; 

save A1_1_Predict_performance.mat R_predict_both R_predict_neg R_predict_pos
